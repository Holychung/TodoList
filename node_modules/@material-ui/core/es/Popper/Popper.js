  ...
  anchorEl: chainPropTypes(PropTypes.oneOfType([PropTypes.object, PropTypes.func]), props => {
    if (props.open) {
      ...
      if (resolvedAnchorEl instanceof HTMLElement) {
        ...
        return new Error(['Material-UI: the `anchorEl` prop provided to the component is invalid.', `It should be a HTMLElement instance but it's \`${resolvedAnchorEl}\` instead.`].join('\n'));
      }
    }
