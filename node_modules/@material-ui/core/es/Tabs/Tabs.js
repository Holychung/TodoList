  ...
  constructor() {
    ...
    this.getConditionalElements = () => {
      ...
      conditionalElements.scrollButtonLeft = showScrollButtons ? React.createElement(ScrollButtonComponent, {
        ...
        className: clsx(classes.scrollButtons, scrollButtons === 'auto' && classes.scrollButtonsAuto)
      }) : null;
    ...
    this.getTabsMeta = (value, direction) => {
      ...
      if (this.tabsRef && value !== false) {
        ...
        if (children.length > 0) {
          ...
          process.env.NODE_ENV !== "production" ? warning(tab, [`Material-UI: the value provided \`${value}\` to the Tabs component is invalid.`, 'None of the Tabs children have this value.', this.valueToIndex.keys ? `You can provide one of the following values: ${Array.from(this.valueToIndex.keys()).join(', ')}.` : null].join('\n')) : void 0;
    ...
    this.updateScrollButtonState = () => {
      ...
      if (scrollable && scrollButtons !== 'off') {
        ...
        const scrollLeft = getNormalizedScrollLeft(this.tabsRef, theme.direction); // use 1 for the potential rounding error with browser zooms.

        const showLeftScroll = theme.direction === 'rtl' ? scrollLeft < scrollWidth - clientWidth - 1 : scrollLeft > 1;
        const showRightScroll = theme.direction !== 'rtl' ? scrollLeft < scrollWidth - clientWidth - 1 : scrollLeft > 1;
  ...
  render() {
    const _this$props = this.props,
      ...
      variant
          ...
          other = _objectWithoutPropertiesLoose(_this$props, ["action", "centered", "children", "classes", "className", "component", "fullWidth", "indicatorColor", "innerRef", "onChange", "scrollable", "ScrollButtonComponent", "scrollButtons", "TabIndicatorProps", "textColor", "theme", "value", "variant"]);
    ...
    const flexContainerClassName = clsx(classes.flexContainer, centered && !scrollable && classes.centered);
    const scrollerClassName = clsx(classes.scroller, !scrollable && classes.fixed, scrollable && classes.scrollable);
