...
class ButtonBase extends React.Component {
  constructor(...args) {
    ...
    this.handleContextMenu = createRippleHandler(this, 'ContextMenu', 'stop');
    this.handleBlur = createRippleHandler(this, 'Blur', 'stop', event => {
      if (this.state.focusVisible) {
    ...
    this.handleKeyDown = event => {
      const {
        ...
        onKeyDown,
        onClick
      } = this.props; // Check if key is already down to avoid repeats being counted as multiple activations

      if (focusRipple && !this.keyDown && this.state.focusVisible && this.ripple && event.key === ' ') {
        this.keyDown = true;
        event.persist();
      ...
      const button = this.getButtonNode(); // Keyboard accessibility for non interactive elements
  ...
  componentDidMount() {
    ...
    if (button == null) {
      throw new Error([`Material-UI: expected an Element but found ${button}.`, 'Please check your console for additional warnings and try fixing those.', 'If the error persists please file an issue.'].join(' '));
    }
  ...
  render() {
    const _this$props = this.props,
      ...
      type
          ...
          other = _objectWithoutPropertiesLoose(_this$props, ["action", "buttonRef", "centerRipple", "children", "classes", "className", "component", "disabled", "disableRipple", "disableTouchRipple", "focusRipple", "focusVisibleClassName", "innerRef", "onBlur", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseDown", "onMouseLeave", "onMouseUp", "onTouchEnd", "onTouchMove", "onTouchStart", "tabIndex", "TouchRippleProps", "type"]);

    const className = clsx(classes.root, classNameProp, this.state.focusVisible && [classes.focusVisible, focusVisibleClassName], disabled && classes.disabled);
