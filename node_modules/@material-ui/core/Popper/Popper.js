...
var Popper = _react.default.forwardRef(function Popper(props, ref) {
  var anchorEl = props.anchorEl,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["anchorEl", "children", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "transition"]);

  var tooltipRef = _react.default.useRef(null);

  var popperRef = _react.default.useRef();
  ...
  var handleRef = (0, _reactHelpers.useForkRef)(tooltipRef, ref);
  ...
  var handleOpen = _react.default.useCallback(function () {
    ...
    popperRef.current = new _popper.default(getAnchorEl(anchorEl), popperNode, (0, _extends2.default)({
      ...
      onCreate: (0, _helpers.createChainedFunction)(handlePopperUpdate, popperOptions.onCreate),
  ...
  anchorEl: (0, _utils.chainPropTypes)(_propTypes.default.oneOfType([_propTypes.default.object, _propTypes.default.func]), function (props) {
    if (props.open) {
      ...
      if (resolvedAnchorEl instanceof HTMLElement) {
        ...
        return new Error(['Material-UI: the `anchorEl` prop provided to the component is invalid.', "It should be a HTMLElement instance but it's `".concat(resolvedAnchorEl, "` instead.")].join('\n'));
      }
    }
